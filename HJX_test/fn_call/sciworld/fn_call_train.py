...
def main():
    ...
    trainer = Trainer(
        ...
        args=TrainingArguments(
            output_dir="/root/AgentGym/HJX_test/fn_call/outputs/model/sciworld_tiny_Llama",
            do_train=True,
            ...
            warmup_ratio=0.1,
            logging_dir="/root/AgentGym/HJX_test/fn_call/outputs/logs/sciworld_tiny_Llama",
